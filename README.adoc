...
It follows the https://docs.couchbase.com/analytics-java-sdk/1.1/project-docs/compatibility.html#api-version[analytics SDK 1.1 API].
...
| `name-sdk:` | Allows us to name the SDK within shared content (*Java Analytics SDK*).
