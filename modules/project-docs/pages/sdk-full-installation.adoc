...
Couchbase publishes all stable artifacts to https://central.sonatype.com/artifact/com.couchbase.client/couchbase-analytics-java-client[Maven Central].
...
----
implementation("com.couchbase.client:couchbase-analytics-java-client:{sdk_current_version}")
----
--
Gradle (Groovy)::
+
