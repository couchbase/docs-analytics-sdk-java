...
and choose an xref:analytics:intro:intro.adoc[Analytics] cluster --
or install a self-managed Enterprise Analytics cluster.
...
The SDK's source code repository includes an https://github.com/couchbase/couchbase-jvm-clients/tree/analytics-java-client-{sdk_current_version}/analytics-java-client/examples[example Maven project] you can copy to get started quickly.
...
public class Example {
  public static void main(String[] args) {
    var connectionString = "https://...:18095";
    var username = "...";
    var password = "...";
