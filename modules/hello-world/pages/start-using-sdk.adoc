...
The SDK's source code repository includes an https://github.com/couchbaselabs/couchbase-jvm-clients/tree/analytics-java-client-{sdk_current_version}/analytics-java-client/examples[example Maven project] you can copy to get started quickly.
