...
Our xref:hello-world:start-using-sdk.adoc[Getting Started pages] cover the basics of making a connection to an Enterprise Analytics cluster (Capella or self-managed).
...
public class Example {
  public static void main(String[] args) {
    var connectionString = "192.168.5.5:18095";
    var username = "...";
    var password = "...";
...
----
couchbases://localhost:8095?timeout.connect_timeout=30s&timeout.query_timeout=2m
----
